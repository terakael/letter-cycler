document.addEventListener('DOMContentLoaded', () => {
    ...
    const allData = {
        ...
        sentences: [
            ...
            'The bat flips in the air.',
            'The pen is on the desk.',
            'A big dog jumps high.',
            'The pig wiggles its tail.',
            'I sip from the cup.',
            'The man mops the floor.',
            'A bug hops on the leaf.',
            'The cat naps on the rug.',
            'I dip the chip.',
            'The dog barks at the van.',
            'A hen pecks at the corn.',
            'I hug my mom.',
            'The sun melts the ice.',
            'A fan spins in the room.',
            'I jog to the park.',
            'The pig digs in the mud.',
            'A man fixes the clock.',
            'I pat the soft cat.',
            'The duck swims in the pond.',
            'A hat sits on my head.',
            'I zip up my jacket.',
            'The log floats on the water.',
            'A nut falls from the tree.',
            'I yell to my friend.',
            'The cat licks its fur.',
            'A dog wags its tail.',
            'I rub my tired eyes.',
            'The mug holds hot tea.',
            'A van drives down the street.',
            'I kick the soft ball.',
            'The red bug sits on the leaf.',
            'A fat cat sleeps in the sun.',
            'I see a big dog run.',
            'The wet mop drips on the floor.',
            'A small bird hops on the log.',
            'The hot mug warms my hands.',
            'I find a shiny red rock.',
            'The sad man sits on the bench.',
            'A fast fish swims in the pond.',
            'The soft bed feels so warm.',
            'I pick ripe apples from the tree.',
            'The loud bell rings at school.',
            'A cute baby waves its tiny hands.',
            'The cold wind blows through the trees.',
            'I help my dad fix the bike.',
            'The bright star shines in the sky.',
            'A brave knight rides his white horse.',
            'The sweet smell comes from the kitchen.',
